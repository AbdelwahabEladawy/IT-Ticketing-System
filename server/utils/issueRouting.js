 ...
 * 
 * ROUTING PRIORITY:
 * 1. If issueType is provided and exists in mapping → Route directly to mapped specialization queue
 ...
 * It only resolves the specialization queue. Existing logic remains untouched.
 * 
